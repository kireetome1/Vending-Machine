...
class MainApp:
    def __init__(self):
        ...
        # Labels
        self.label = tk.Label(self.win, text='Your Balance is:', font=('arial black', 15, 'bold'))
        self.label.place(x=0, y=0)

        self.label2 = tk.Label(self.win, text=str(self.total_amount), font=('arial black', 15, 'bold'))
        self.label2.place(x=200, y=0)

        self.label3 = tk.Label(self.win, text='Please Insert Money:', font=('arial black', 15, 'bold'))
        self.label3.place(x=0, y=50)

        # Buttons
        self.insert_button = tk.Button(self.win, text='Insert Money', command=self.insert_money,
                                       font=('arial black', 12))
        self.insert_button.place(x=220, y=100)

        self.buy_button = tk.Button(self.win, text='Buy Drink', command=self.buy_drink, font=('arial black', 12))
        self.buy_button.place(x=240, y=150)

        self.quit_button = tk.Button(self.win, text='Quit', command=self.win.quit, font=('arial black', 12))
