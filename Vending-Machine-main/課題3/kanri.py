...
def main():
    ...
    button2=tk.Button(win,text='Sale Verification',command=sales_verification,font=('arial black', 20,'bold'),bg='blue', fg="#fff", activebackground="maroon", activeforeground="black")#insert command later on
